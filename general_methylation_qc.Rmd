...
Import the JHS methylation M-values that have been adjusted for any batch, plate, and plate position affects with the ComBat function in the sva R package.
...
# Save just the CpG identifiers from the ListRemoveProber for input into GLINT for exclusion after inference of population structure.
